...
public class LCCoursesListAdapter extends RecyclerView.Adapter<LCCoursesListAdapter.viewHolder> implements Filterable {

    Context context;
    ArrayList<Course> arrayList,arrayListFiltered;

    public LCCoursesListAdapter(Context context, ArrayList<Course> arrayList) {
    ...
    public  viewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.lc_course_list_item, viewGroup, false);
